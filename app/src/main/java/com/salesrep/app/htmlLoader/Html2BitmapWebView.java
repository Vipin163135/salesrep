...
import com.salesrep.app.htmlLoader.content.ProgressChangedListener;
import com.salesrep.app.htmlLoader.content.WebViewContent;
    ...
    Html2BitmapWebView(@NonNull final Context context, @NonNull final WebViewContent content, final int bitmapWidth, final int measureDelay, final int screenshotDelay, final boolean strictMode, @Nullable final Integer textZoom, @Nullable Html2BitmapConfigurator html2BitmapConfigurator) {
        ...
        mainHandler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(bitmapWidth, View.MeasureSpec.EXACTLY);
                webView.measure(bitmapWidth, context.getResources().getDimensionPixelOffset(com.intuit.sdp.R.dimen._260sdp));
